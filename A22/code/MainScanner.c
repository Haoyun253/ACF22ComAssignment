...
/* External objects */
extern cloud_int line; /* Source code line numbers - defined in scanner.c */
 ...
 * -------------------------------------------------------------
 */
cloud_void printScannerError(cloud_char* fmt, ...);
cloud_void displayScanner(BufferReader* ptrBuffer);
cloud_long getScannerFilesize(cloud_char* fname);
...
cloud_int mainScanner(cloud_int argc, cloud_char** argv) {
